...
# Build environment
grub_target_cc='x86_64-openwrt-linux-uclibc-gcc'
grub_target_cc_version='x86_64-openwrt-linux-uclibc-gcc (OpenWrt/Linaro GCC 4.8-2014.04 unknown) 4.8.3'
...
grub_target_cppflags=' -Wall -W -I$(top_srcdir)/include -I$(top_builddir)/include  -DGRUB_MACHINE_PCBIOS=1 -DGRUB_MACHINE=I386_PC -m32 -nostdinc -isystem /home/qxw/projects/OpenWifi/staging_dir/toolchain-x86_64_gcc-4.8-linaro_uClibc-0.9.33.2/lib/gcc/x86_64-openwrt-linux-uclibc/4.8.3/include'
grub_target_ccasflags=' -g -m32'
grub_target_ldflags=' -m32 -Wl,-melf_i386 -Wl,--build-id=none'
grub_target_strip='x86_64-openwrt-linux-uclibc-strip'
grub_target_nm='x86_64-openwrt-linux-uclibc-nm'
grub_target_ranlib='x86_64-openwrt-linux-uclibc-ranlib'
grub_target_objconf=''
grub_target_obj2elf=''
