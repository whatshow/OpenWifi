...
if test -n "$STAGING_DIR"; then
	...
	: ${EGREP="/home/buildbot/slave-local/x86_generic/build/staging_dir/host/bin/grep -E"}
	: ${FGREP="/home/buildbot/slave-local/x86_generic/build/staging_dir/host/bin/grep -F"}
	: ${GREP="/home/buildbot/slave-local/x86_generic/build/staging_dir/host/bin/grep"}
	: ${SED="/home/buildbot/slave-local/x86_generic/build/staging_dir/host/bin/sed"}
fi
